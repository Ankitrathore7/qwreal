...
$(function () {
  ...
  // Check if there is a saved theme preference or apply default light theme
  document.addEventListener('DOMContentLoaded', () => {
    const savedTheme = localStorage.getItem('theme');
    if (savedTheme === 'dark-blue' || (savedTheme === null && prefersDarkMode)) {
      body.classList.add('dark-blue');
    } else {
      body.classList.remove('dark-blue'); // Ensure that 'dark-blue' class is removed to force light theme
    }
  });
  
  modeSwitcher.addEventListener('click', () => {
    // Toggle the dark-blue class on the body
    body.classList.toggle('dark-blue');
  
    // Save the theme preference in local storage
    const theme = body.classList.contains('dark-blue') ? 'dark-blue' : 'light-theme';
